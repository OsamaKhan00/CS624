...
declare const _default: React.FunctionComponent<Omit<{
    ...
    iconSize: number;
    button: boolean;
} & Partial<import("react-native-elements/dist/config").ThemeProps<SocialIconProps>>, keyof import("react-native-elements/dist/config").ThemeProps<T>>> | React.ForwardRefExoticComponent<{
    Component?: typeof React.Component;
    type?: SocialMediaType;
    button?: boolean;
    onPress?(): void;
    ...
    iconSize: number;
    button: boolean;
} & Partial<import("react-native-elements/dist/config").ThemeProps<SocialIconProps>>>;
