...
declare const _default: React.FunctionComponent<Omit<{
    ...
    modalProps: {};
    isVisible: boolean;
} & Partial<import("react-native-elements/dist/config").ThemeProps<BottomSheetProps>>, keyof import("react-native-elements/dist/config").ThemeProps<T>>> | React.ForwardRefExoticComponent<{
    containerStyle?: StyleProp<ViewStyle>;
    modalProps?: ModalProps;
    isVisible?: boolean;
} & {
    modalProps: {};
    isVisible: boolean;
} & Partial<import("react-native-elements/dist/config").ThemeProps<BottomSheetProps>>>;
